...
/**
 * Servlet implementation class ProcessViewRequestServlet
 */
public class ProcessViewRequestServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProcessViewRequestServlet() {
        super();
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String html = "<head>\r\n"
				...
				+ "            <p>Employee's pending reimbursement that need to be resolved</p>            \r\n"
		...
		penList = rdao.viewPending(Integer.parseInt(eid));
